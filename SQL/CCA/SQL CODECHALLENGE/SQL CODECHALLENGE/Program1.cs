    ...
    class Program1
    {
        static void Main(string[] args)
        {
            List<Employee> empList = new List<Employee>()
            {
                ...
                new Employee { EmployeeID = 1002, FirstName = "asdin",   LastName = "dhalla",     Title = "assisttManager", DOB = DateTime.Parse("20-08-1994"), DOJ = DateTime.Parse("07-07-2012"), City = "Mumbai" },
            ...
            // c-->
            Console.WriteLine("\nc) Employees with Title = assistManager:\n");
            var asstManagers = empList.Where(e => e.Title == "assisttManager");
            foreach (var emp in assstManagers)
                Display(emp);
